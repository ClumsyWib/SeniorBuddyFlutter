...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Color get _primaryColor {
    switch (widget.role) {
      ...
      case 'senior':
        return const Color(0xFF7C3AED); // Deep Violet (Matches Photo)
      case 'caretaker':
        return const Color(0xFF2563EB); // Royal Blue
      case 'volunteer':
        return const Color(0xFFD97706); // Rich Amber
      default:
  ...
  void _handleSignup() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final result = await _apiService.register(
        ...
        phoneNumber:
            _phoneController.text.trim(), // Included trimmed phone number
      );
      ...
      if (mounted) {
        ...
        if (result['success']) {
          ...
          // Update FCM Token after signup safely
          try {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: const TextStyle(fontSize: 18),
                    prefixIcon:
                        Icon(Icons.email, color: _primaryColor, size: 28),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: const TextStyle(fontSize: 18),
                    prefixIcon:
                        Icon(Icons.phone, color: _primaryColor, size: 28),
                ...
                TextFormField(
                  ...
                  obscureText:
                      _obscurePassword, // Variable controls the hiding factor
                  style: const TextStyle(fontSize: 18),
                  decoration: InputDecoration(
                    labelText: 'Password',
                    labelStyle: const TextStyle(fontSize: 18),
                    prefixIcon:
                        Icon(Icons.lock, color: _primaryColor, size: 28),
                ...
                TextFormField(
                  ...
                  obscureText:
                      _obscureConfirmPassword, // Mask verification block typing
                  style: const TextStyle(fontSize: 18),
                  decoration: InputDecoration(
