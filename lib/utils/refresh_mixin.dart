...
class _ResumeObserver with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.paused ||
        state == AppLifecycleState.inactive) onPause();
  }
}
...
mixin PeriodicRefreshMixin<T extends StatefulWidget> on State<T> {
  ...
  /// Interval for periodic refresh. Default is 30s. Override if needed.
  Duration get refreshInterval => kDataRefreshInterval;
