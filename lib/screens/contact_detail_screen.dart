...
class ContactDetailScreen extends StatelessWidget {
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    _buildDetailRow(context, Icons.family_restroom, 'Relationship',
                        contact['relationship'] ?? 'N/A'),
                    const Divider(height: 32),
                    _buildDetailRow(
                        context, Icons.phone, 'Phone', contact['phone'] ?? 'N/A'),
                    if (contact['email'] != null) ...[
                      const Divider(height: 32),
                      _buildDetailRow(context, Icons.email, 'Email', contact['email']),
                    ],
                  ],
                ),
              ),
  ...
  String _formatPhone(String phone) {
    ...
    if (!cleaned.startsWith('+') && cleaned.isNotEmpty) {
      cleaned =
          '+91$cleaned'; // Change +91 to your desired default country code
    }
    return cleaned;
  }
