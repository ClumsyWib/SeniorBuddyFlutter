...
class _EditAppointmentScreenState extends State<EditAppointmentScreen> {
  ...
  void initState() {
    ...
    _descriptionController.text =
        widget.appointment['description']?.toString() ?? '';
    _selectedType =
        widget.appointment['appointment_type']?.toString() ?? 'doctor';
  ...
  Future<void> _saveAppointment() async {
    ...
    final result = await _apiService.updateAppointment(
      _appointmentId!,
    ...
    final msg = err is Map
        ? (err['detail'] ?? err['message'] ?? 'Update failed').toString()
        : err.toString();
    ScaffoldMessenger.of(context).showSnackBar(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) =>
                      setState(() => _selectedType = v ?? 'doctor'),
                ),
                const SizedBox(height: 20),
                ListTile(
