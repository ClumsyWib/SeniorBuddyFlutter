...
class VolunteerEmergencyAlertsScreen extends StatefulWidget {
  ...
  @override
  State<VolunteerEmergencyAlertsScreen> createState() =>
      _VolunteerEmergencyAlertsScreenState();
}

class _VolunteerEmergencyAlertsScreenState
    extends State<VolunteerEmergencyAlertsScreen> {
  ...
  Future<void> _acceptAlert(int id) async {
    ...
    if (result['success']) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Emergency Accepted!')));
      _loadAlerts();
    }
  }
      ...
      child: Scaffold(
        ...
        body: _isLoading
            ...
            : _alerts.isEmpty
                ? Center(
                    child: Text(
                        'No ${_currentFilter == 'active' ? 'active' : 'past'} emergencies.',
                        style:
