...
class VitalsTrackerScreen extends StatefulWidget {
  ...
  const VitalsTrackerScreen({Key? key, required this.seniorId, this.userRole = kRoleCaretaker}) : super(key: key);
      ...
      body: _isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            if (canCaretakerWrite(widget.userRole)) const SizedBox(height: 24),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(fontSize: 15, color: Color(0xFFE91E63)),
                          ),
                        ),
                      ],
                    ),
  ...
  Widget _buildRecordItem(dynamic record) {
    return Card(
      ...
      child: InkWell(
        ...
        child: ListTile(
        title: Text(
          "${record['record_date']} at ${record['record_time']}",
        ),
        subtitle: Wrap(
          spacing: 12,
          children: [
