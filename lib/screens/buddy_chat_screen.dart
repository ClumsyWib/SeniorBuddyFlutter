...
class _BuddyChatScreenState extends State<BuddyChatScreen> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _loadLanguage() async {
    ...
    setState(() {
      _languageCode = code;
      // Map common ones, default to code-IN
      _localeId = _mapLanguageToLocale(code);
    });
    // Update TTS if already initialized
  ...
  void _toggleListening() async {
    ...
    _stt.listen(
      ...
      localeId: _localeId.replaceAll('-', '_'), // STT often uses underscores
      ...
      if (result['success']) {
        ...
        if (actionResult != null) {
          setState(() => _messages.add({
            ...
            'success': (actionResult['success'] ?? false).toString(),
          }));
        }
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('Hi! I\'m Buddy AI', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 40),
                          child: Text(
                            'I can help you add friends, manage medicines, book appointments, or just chat. How can I assist you today?',
