...
class _AddSeniorScreenState extends State<AddSeniorScreen> {
      ...
      if (result['success']) {
        ...
        if (data != null && data['pair_code'] != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Saved but connection code missing!'), backgroundColor: Colors.orange)
          );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Senior', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(labelText: 'Mobility Status', prefixIcon: Icon(Icons.directions_walk)),
                  items: const [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(labelText: 'Care Level', prefixIcon: Icon(Icons.health_and_safety)),
                  items: const [
                ...
                TextFormField(
                  ...
                  maxLines: 2,
                  decoration: const InputDecoration(labelText: 'Medical Conditions (Optional)', prefixIcon: Icon(Icons.medical_information)),
                ),
                const SizedBox(height: 16),
                TextFormField(
                ...
                ElevatedButton(
                  ...
                  child: _isLoading 
                    ...
                    : const Text('Save Senior', style: TextStyle(fontSize: 18)),
                )
              ],
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: const TextStyle(fontSize: 40, fontWeight: FontWeight.bold, letterSpacing: 8, color: Color(0xFF4CAF50)),
              ),
