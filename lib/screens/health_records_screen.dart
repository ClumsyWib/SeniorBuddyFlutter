...
class HealthRecordsScreen extends StatefulWidget {
  ...
  const HealthRecordsScreen({Key? key, required this.onDataChanged, this.seniorId, this.userRole = kRoleFamily})
      : super(key: key);
...
class _HealthRecordsScreenState extends State<HealthRecordsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: (canFamilyWrite(widget.userRole) && _tabController.index == 1)
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                child: const Icon(Icons.event, color: Color(0xFF4CAF50), size: 28),
              ),
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 20),
                          const Text('No medicines found', style: TextStyle(fontSize: 24)),
  ...
  Future<void> _openFullMedicinesPage() async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MedicinesScreen(seniorId: widget.seniorId)),
    );
    _loadMedicines(showLoading: false);
    widget.onDataChanged();
  }
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                child: const Icon(Icons.medication, color: Color(0xFFE53935), size: 28),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: Column(
