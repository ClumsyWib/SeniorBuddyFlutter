...
class AddActivityScreen extends StatefulWidget {
  ...
  const AddActivityScreen({Key? key, required this.seniorId, required this.seniorName}) : super(key: key);
...
class _AddActivityScreenState extends State<AddActivityScreen> {
  ...
  final List<Map<String, dynamic>> _activityTypes = [
    ...
    {'value': 'medicine', 'label': 'Medicine / Treatment', 'icon': Icons.medication},
    {'value': 'exercise', 'label': 'Exercise / Mobility', 'icon': Icons.directions_run},
    {'value': 'hygiene', 'label': 'Hygiene / Bathing', 'icon': Icons.clean_hands},
    {'value': 'mood', 'label': 'Mood / Social Interaction', 'icon': Icons.emoji_emotions},
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Activity Type', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ...
              const SizedBox(height: 24),
              const Text('Notes / Observation', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 12),
              TextFormField(
                controller: _notesController,
                maxLines: 4,
                decoration: InputDecoration(
                  hintText: 'Add details about the activity (e.g., "Ate breakfast well", "Refused walk today")',
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(type['icon'], color: isSelected ? const Color(0xFF2196F3) : Colors.grey[600]),
