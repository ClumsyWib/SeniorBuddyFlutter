...
class _EmergencyContactsScreenState extends State<EmergencyContactsScreen>
  ...
  Future<void> _loadContacts() async {
    ...
    final result =
        await _apiService.getEmergencyContacts(seniorId: widget.seniorId);
    if (mounted) {
  ...
  Future<void> _deleteContact(int id) async {
    ...
    if (confirmed == true) {
      final result = await _apiService.deleteEmergencyContact(id);
      if (mounted) {
        if (result['success']) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Pull down to refresh or add a contact.'),
