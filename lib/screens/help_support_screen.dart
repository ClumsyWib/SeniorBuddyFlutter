...
class HelpSupportScreen extends StatelessWidget {
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildContactCard(
            ...
            () => _launchUrl('https://maps.google.com/?q=123+Care+Street', context),
          ),
          const SizedBox(height: 32),
          const Text('FAQs', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          _buildFAQ('How do I create an appointment?', 'Click the green + button on the home screen.'),
          _buildFAQ('How do I contact my caretaker?', 'Go to Connect tab and view your caretaker details.'),
        ],
      ),
    );
  }
  ...
  Widget _buildFAQ(String question, String answer) {
    return Card(
      ...
      child: ExpansionTile(
        title: Text(question, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
        children: [
          Padding(
