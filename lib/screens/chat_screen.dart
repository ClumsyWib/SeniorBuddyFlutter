...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _loadMessages({bool silent = false}) async {
    ...
    final result = await _api.getConversation(widget.otherUserId);
    if (mounted) {
  ...
  Future<void> _sendMessage() async {
    ...
    final result = await _api.sendMessage(widget.otherUserId, text);
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Start chatting with ${widget.otherUserName}!', style: TextStyle(color: Colors.grey[400], fontSize: 12)),
                          ],
                        ),
                      )
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          int senderId = (senderVal is Map) ? senderVal['id'] : (senderVal as int? ?? 0);
                          bool isMe = senderId != widget.otherUserId;
                          
                          // DEBUG LOG
                          print('💬 Rendering message: ${msg['message']} | senderId: $senderId | otherId: ${widget.otherUserId} | isMe: $isMe');
