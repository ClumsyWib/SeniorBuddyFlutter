              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: widget.senior['photo'] != null
                      ? NetworkImage(
                          '${widget.senior['photo']}?v=${DateTime.now().millisecondsSinceEpoch}')
                      : null,
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _buildInfoRow(
                        'Care Level', widget.senior['care_level'] ?? 'Unknown'),
                  ],
                ),
              ),
            ),
              ...
              onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) => DailyActivityScreen(
                    seniorId: widget.senior['id'],
                    seniorName: widget.senior['name'] ?? 'Senior',
                    userRole: widget.userRole,
                  ),
                ),
              ),
                  ...
                  if (result['success']) {
                    ...
                    if (assignment != null) {
                      final caretakerInfo = await ApiService().getList(
                          'care-assignments/my_caretaker/?senior=${widget.senior['id']}');
                      if (caretakerInfo['success']) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => CaretakerSelectionScreen(
                                seniorId: widget.senior['id']),
                          ),
                        );
                      }
